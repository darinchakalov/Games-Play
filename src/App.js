			...
			<section id="game-details">
				...
				<div className="info-section">
					...
					<p className="text">
						...
						work with an Orc to find a weapon everyone is prepared to kill for. Set in a world where fantasy
						creatures live side by side with humans. A human cop is forced to work with an Orc to find a
